import AppPhoto from "../assets/phone.jpg";
import DashboardPhoto from "../assets/dashboard.jpg";
import ResourcePhoto from "../assets/resources.webp";

import { TabletSmartphone, LayoutDashboard, Activity } from "lucide-react";
import ServiceBlock from "./ServiceBlock";

export default function ServicesWithPhotos() {
  return (
    <>
      <div className="mt-12">
